...
public class BiddingBookingActivity extends AppCompatActivity {

    Button mClose,mAccept,mReject,mSuggest;
    TextView mTitle,mHotelName;
    CustomFontTextView mBiddingPrice,mGuestCount,mRoomCount,mCID,mCOD;

    String title,message,fds,tds,price,rooms,adult,child,cit,cot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bidding_booking);

        profileId = PreferenceHandler.getInstance(BiddingBookingActivity.this).getUserId();
       ...
       /* mRejected = (LinearLayout)findViewById(R.id.rejected_layout);
        ...
        mAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Intent intent = new Intent(BiddingBookingActivity.this, HotelDetailsActivity.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt(Constants.HOTEL_ID, hotelId);
                    ...
                    bundle.putInt("DisplayPrice", Integer.parseInt(price));
                    bundle.putInt("SellRate", Integer.parseInt(price));
        ...
        mClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BiddingBookingActivity.this.finish();
            }
        });
    ...
    private void getAgentDetails(final int hotelid) {
        ...
        new ThreadExecuter().execute(new Runnable() {
            @Override
            public void run() {
                String auth_string = Util.getToken(BiddingBookingActivity.this);//"Basic " +  Base64.encodeToString(authentication.getBytes(), Base64.NO_WRAP);
    ...
    public void sendNotification(final HotelNotification fireBaseModel) {
        ...
        new ThreadExecuter().execute(new Runnable() {
            @Override
            public void run() {
                String auth_string = Util.getToken(BiddingBookingActivity.this);
...
//                List<RouteDTO.Routes> list = new ArrayList<RouteDTO.Routes>();
                        ...
                        if (statusCode == 200) {
                            ...
                            Toast.makeText(BiddingBookingActivity.this, "Notification Send Successfully", Toast.LENGTH_SHORT).show();
                            //sendEmailattache();
                            ...
                            Toast.makeText(BiddingBookingActivity.this, " failed due to status code:" + statusCode, Toast.LENGTH_SHORT).show();
                        }
//                callGetStartEnd();
                    }
