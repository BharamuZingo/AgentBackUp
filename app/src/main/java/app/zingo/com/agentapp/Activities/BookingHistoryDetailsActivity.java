...
public class BookingHistoryDetailsActivity extends AppCompatActivity {
    ...
    CustomFontTextView mCancelBtn,mInvoiceBtn,mHomeBtn,mBookingCheckInTime,mBookedHotelName,mCustomerName,mGuestInfo,mTotalPrice,
            mCheckInDate,mCheckOutDate,mNoOfNights,mBookedHotelAdd,mCustomeName,mBookingMessageText,mBookingNumber,
            mTotalAmount,mDiscountAmount,mCall,mTotalPayAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Intent main = new Intent(BookingHistoryDetailsActivity.this, MainActivity.class);
                main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//mainActivityIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                main.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK| Intent.FLAG_ACTIVITY_CLEAR_TASK );
                startActivity(main);*/
                BookingHistoryDetailsActivity.this.finish();
            }
        });
        mInvoiceBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(BookingHistoryDetailsActivity.this, "Your Booking is cancelled Successfully", Toast.LENGTH_SHORT).show();
//                Intent main = new Intent(BookingHistoryDetailsActivity.this, MainActivity.class);
//                main.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
////mainActivityIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                main.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK| Intent.FLAG_ACTIVITY_CLEAR_TASK );
...
//mainActivityIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    private void showalertbox(final Bookings1 bookings1) throws Exception{
        ...
        final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(BookingHistoryDetailsActivity.this);
    ...
    private void cancelBooking(final Bookings1 booked) {
        final ProgressDialog dialog = new ProgressDialog(BookingHistoryDetailsActivity.this);
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                String authenticationString = Util.getToken(BookingHistoryDetailsActivity.this);
                ...
                checkout.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        try
                        {
                            if(response.code() == 204)
                            {
                                ...
                                Toast.makeText(BookingHistoryDetailsActivity.this,"Booking cancelled successfully",Toast.LENGTH_SHORT).show();
                            ...
                            else
                            {
                                ...
                                Toast.makeText(BookingHistoryDetailsActivity.this,"Please try after some time",Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception ex)
                        {
                    ...
                    public void onFailure(Call<String> call, Throwable t) {
                        ...
                        Toast.makeText(BookingHistoryDetailsActivity.this,t.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public void call()
    {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(BookingHistoryDetailsActivity.this);
        ...
        builder.setPositiveButton("Call", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (ActivityCompat.checkSelfPermission(BookingHistoryDetailsActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void sendfirebaseNotification(final HotelNotification notification, final Bookings1 bookings1) {
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                String auth_string = Util.getToken(BookingHistoryDetailsActivity.this);//"Basic " +  Base64.encodeToString(authentication.getBytes(), Base64.NO_WRAP);
                ...
                response.enqueue(new Callback<ArrayList<String>>() {
                    ...
                    public void onResponse(Call<ArrayList<String>> call, Response<ArrayList<String>> response) {
                        ...
                        {
                            Toast.makeText(BookingHistoryDetailsActivity.this, "Sending notification failed due to "+response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<ArrayList<String>> call, Throwable t) {
                        ...
                        Toast.makeText(BookingHistoryDetailsActivity.this, "Sending notification failed due to "+t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void savenotification(final NotificationManager notification, final Bookings1 bookings1) {
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                System.out.println("Hotel id = "+notification.getHotelId());
                String auth_string = Util.getToken(BookingHistoryDetailsActivity.this);
                NotificationApi travellerApi = Util.getClient().create(NotificationApi.class);
    ...
    private void getHotel(final int id){
        ...
        final ProgressDialog progressDialog = new ProgressDialog(BookingHistoryDetailsActivity.this);
...
//                            listCities.add(dto);
                            ...
                            if (progressDialog!=null)
                                progressDialog.dismiss();
                            Toast.makeText(BookingHistoryDetailsActivity.this, response.message(), Toast.LENGTH_SHORT).show();
                        }
//                callGetStartEnd();
                    }
    ...
    private void initializeFonts(){
        ...
        try {
            ...
            rf = BaseFont.createFont(BaseFont.HELVETICA, BaseFont.CP1252, BaseFont.NOT_EMBEDDED);
    ...
    /*private void gethotelDetails(){
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                HotelOperations apiService =
                        Util.getClient().create(HotelOperations.class);
                Call<HotelDetails> call = apiService.getHotelByHotelId(auth_string,PreferenceHandler.getInstance(BookingHistoryDetailsActivity.this).getHotelID());
...
//                List<RouteDTO.Routes> list = new ArrayList<RouteDTO.Routes>();
                        ...
                        if (statusCode == 200) {
                            ...
                            Toast.makeText(BookingHistoryDetailsActivity.this, "Login failed due to status code: "+response.message(), Toast.LENGTH_SHORT).show();
                        }
//                callGetStartEnd();
                    }
