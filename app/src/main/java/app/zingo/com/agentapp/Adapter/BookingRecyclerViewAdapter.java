...
import app.zingo.com.agentapp.Activities.BookingHistoryDetailsActivity;
...
public class BookingRecyclerViewAdapter extends RecyclerView.Adapter<BookingRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(bookings1 != null && traveller != null)
        {
            ...
            if(bookings1.getRoomId() != 0 && bookings1.getBookingStatus() != null && !bookings1.getBookingStatus().equalsIgnoreCase("quick"))
            {
                getRoomNo(bookings1.getRoomId(),holder.mBookedRoom);
                holder.mBookedRoom.setBackgroundColor(context.getResources().getColor(R.color.default_textcolor));
                holder.mBookedRoom.setTextColor(Color.parseColor("#706f6f"));
            }
            else if(bookings1.getRoomId() == 0 && bookings1.getBookingStatus() != null && bookings1.getBookingStatus().equalsIgnoreCase("quick"))
            {
                holder.mBookedRoom.setText(" Allocate Room ");
                holder.mBookedRoom.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary));
                holder.mBookedRoom.setTextColor(context.getResources().getColor(R.color.default_textcolor));
                holder.mBookedRoom.setVisibility(View.GONE);
            }
            ...
            holder.mBookedRoom.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        // Toast.makeText(context,"Allocate room",Toast.LENGTH_SHORT).show();
            ...
            /*Traveller traveller = activeTraveller.get(position);
            Bookings1 bookings1 = activeBookings.get(position);*/
            ...
            holder.mparent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //bundle.putSerializable("ExpectedCheckInsOrCheckOutActivityTraveller",traveller);
