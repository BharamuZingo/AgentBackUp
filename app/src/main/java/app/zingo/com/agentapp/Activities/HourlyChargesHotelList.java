...
public class HourlyChargesHotelList extends AppCompatActivity {
...
//                System.out.println("Feature Size=="+featureList.size());
                ...
                // getHotels("normal");
                Toast.makeText(HourlyChargesHotelList.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
            ...
            mFilterParent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //showalert();
                    Intent filter = new Intent(HourlyChargesHotelList.this, FilterActivity.class);
            ...
            mModify.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent1 = new Intent(HourlyChargesHotelList.this,MainActivity.class);
                ...
                public void onItemClick(View view, int position) {
                    ...
                    try {
                        ...
                        if (textView.getText().toString().equalsIgnoreCase("Sold out")) {
                            Toast.makeText(HourlyChargesHotelList.this, "Sorry! No rooms available", Toast.LENGTH_SHORT).show();
                        } else {
            ...
            toolbar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent1 = new Intent(HourlyChargesHotelList.this,MainActivity.class);
                    startActivity(intent1);
                    //HourlyChargesHotelList.super.onBackPressed();
                    HourlyChargesHotelList.this.finish();
                }
            });
    ...
    {
        final BottomSheetDialog mBottomSheetDialog = new BottomSheetDialog(HourlyChargesHotelList.this);
    ...
    private void getHotels(final String filterType){
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                String auth_string = Util.getToken(HourlyChargesHotelList.this);
                HotelApi apiService =
                    ...
                    public void onResponse(Call<ArrayList<HotelDetails>> call, Response<ArrayList<HotelDetails>> response) {
                        ...
                        try
                        {
                            if (statusCode == 200) {
                                            ...
                                            if(featureList!=null&&featureList.size()!=0){
                                                ...
                                                if(fillterHotels!=null&&fillterHotels.size()!=0){
                                                    ...
                                                    if(minPrice==0&&maxPrice==0){
                                                        ...
                                                        adapter = new HotelListAdapter(HourlyChargesHotelList.this, allApprovedHotels,checkInDate,checkOutDate,latitude,longitude,checkInTime,checkOutTime,room,price,"all");
                                ...
                                {
                                    //Toast.makeText(HourlyChargesHotelList.this, "No Hotels", Toast.LENGTH_SHORT).show();
                                    mNoResult.setVisibility(View.VISIBLE);
                                    mScrollView.setVisibility(View.GONE);
                                }
                                ...
                                mNoResult.setVisibility(View.VISIBLE);
                                mScrollView.setVisibility(View.GONE);
                                //Toast.makeText(HourlyChargesHotelList.this, " failed due to status code:"+statusCode, Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception ex)
                        {
    ...
    private void getHotelsByLocalty(final String locality, final String city,final String filterType){
        ...
        new ThreadExecuter().execute(new Runnable() {
            ...
            public void run() {
                ...
                HotelApi apiService =
                        Util.getClient().create(HotelApi.class);
                //Call<ArrayList<HotelDetails>> call = apiService.getHotelByLocalty(auth_string, HourlyChargesHotelList.this.locality);
                    ...
                    public void onResponse(Call<ArrayList<HotelDetails>> call, Response<ArrayList<HotelDetails>> response) {
                        ...
                        try{
                            if (statusCode == 200) {
                                                ...
                                                if(featureList!=null&&featureList.size()!=0){
                                                    ...
                                                    if(fillterHotels!=null&&fillterHotels.size()!=0){
                                                        ...
                                                        if(minPrice==0&&maxPrice==0){
                                                            ...
                                                            adapter = new HotelListAdapter(HourlyChargesHotelList.this, approvedHotels,checkInDate,
                                                            ...
                                                            if(priceHotels!=null&&priceHotels.size()!=0){
                                                                ...
                                                                adapter = new HotelListAdapter(HourlyChargesHotelList.this, approvedHotels,checkInDate,checkOutDate,latitude,longitude,checkInTime,checkOutTime,room,price,"filter");
                                                                mLocalHotelList.setAdapter(adapter);
                                                                recyclerAnimation();
                                                            }else{
                                                    ...
                                                    if(approvedHotels!=null&&approvedHotels.size()!=0){
                                                        ...
                                                        if(minPrice==0&&maxPrice==0){
                                                            ...
                                                            if(priceHotels!=null&&priceHotels.size()!=0){
                                                                ...
                                                                approvedHotels = priceHotels;
                                                                adapter = new HotelListAdapter(HourlyChargesHotelList.this, approvedHotels,checkInDate,checkOutDate,latitude,longitude,checkInTime,checkOutTime,room,price,"all");
                                                                mLocalHotelList.setAdapter(adapter);
                                                                recyclerAnimation();
                                                            }else{
                                ...
                                {
                                    //Toast.makeText(HourlyChargesHotelList.this, "No Hotels in your search location", Toast.LENGTH_SHORT).show();
                                    // getHotels("normal");
                                    //mPreloaderList.setVisibility(View.GONE);
                                    //mProgress.setVisibility(View.GONE);
                                    mNoHotels.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            case android.R.id.home:
                Intent main = new Intent(HourlyChargesHotelList.this, MainActivity.class);
                startActivity(main);
                this.finish();
                break;
...
*/
            ...
            if(approvedHotels != null && approvedHotels.size() != 0)
            {
                Collections.sort(approvedHotels, new Comparator<HotelDetails>() {
                    ...
                    public int compare(HotelDetails o1, HotelDetails o2) {
                        ...
                        {
                            return o1.getRooms().get(0).getHourlyCharges() - o2.getRooms().get(0).getHourlyCharges();
                        }
                        else
                        {
                            return 1;
               ...
               /* if(approvedHotelsDistance != null)
                ...
                adapter = new HotelListAdapter(HourlyChargesHotelList.this, approvedHotels,checkInDate,checkOutDate,
            ...
            if(approvedHotels != null && approvedHotels.size() != 0)
            {
                Collections.sort(approvedHotels, new Comparator<HotelDetails>() {
                    ...
                    public int compare(HotelDetails o1, HotelDetails o2) {
                        if(o1.getRooms() != null && o1.getRooms().size() != 0 && o2.getRooms() != null && o2.getRooms().size() != 0)
                        {
                            return o2.getRooms().get(0).getHourlyCharges() - o1.getRooms().get(0).getHourlyCharges();
                        }
                        else
                        {
                            return 1;
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater inflater = HourlyChargesHotelList.this.getMenuInflater();
