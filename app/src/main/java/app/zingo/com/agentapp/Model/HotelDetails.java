...
public class HotelDetails implements Serializable{
    ...
    *//*private String hotelLocality;
    ...
    public HotelDetails(int hotelId,String hotelName,ArrayList aminetiesList,ArrayList rooms,String hotelDisplayName,
                        ...
                        String standardCheckInTime,String standardCheckOutTime,String hotelTimeZone,boolean is24HourCheckIn,ArrayList<HotelDocuments> hotelDocuments,
   ...
   /* public void setAccountsInfo(ArrayList accountsInfo) {
    ...
    public boolean equals(Object obj) {
        try {
            HotelDetails licenceDetail  = (HotelDetails) obj;
            return hotelName.equals(licenceDetail.getHotelName());
        }
        catch (Exception e)
        {
            return false;
